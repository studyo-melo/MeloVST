...
std::string generateTimestampedFilename(const std::string& baseName, const std::string& extension) {
...
const std::string wavFilename = generateTimestampedFilename("output", "wav");
